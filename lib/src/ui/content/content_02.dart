                        ...
                        children: [
                          AnimatedOpacity(
                            ...
                            child: AnimatedPadding(
                              ...
                              curve: Curves.ease,
                              padding:
                                  EdgeInsets.only(left: controller.offset.value > 480 ? 60 : 0),
                              child: SizedBox(
                                width: 540,
                                child: Column(
                                  ...
                                  children: const [
                                    ...
                                    Text(
                                      '종이시험지 따로, PDF 시험지 따로.'
                                      '\n그동안 공부하기 번거로우셨죠?'
                                      '\n이젠 디지털시험지 하나로 채점, 오답노트, 문제풀기까지 모두 가능해요.',
                                      style: TextStyle(
                                        color: Color(0xFF37352F),
                                        fontSize: 18,
                          ...
                          AnimatedOpacity(
                            ...
                            child: AnimatedPadding(
                              ...
                              curve: Curves.ease,
                              padding:
                                  EdgeInsets.only(right: controller.offset.value > 480 ? 60 : 0),
                        ...
                        children: [
                          AnimatedOpacity(
                            ...
                            child: AnimatedPadding(
                              ...
                              curve: Curves.ease,
                              padding:
                                  EdgeInsets.only(left: controller.offset.value > 1230 ? 60 : 0),
                              child: Obx(() => Image.asset(
                                'assets/content_02_02.png',
                                width: LayoutController.to.maxWidth.value < 1560
                                    ? LayoutController.to.maxWidth.value - 900
                                    : 660,
                              )),
                            ),
                          ),
                                ...
                                child: Column(
                                  ...
                                  children: const [
                                    ...
                                    Text(
                                      ...
                                      '\n일일이 베껴 쓰는 필기시간을 줄여주니까 오로지 오답공부에만 집중할 수 있어요.',
                                      style: TextStyle(
                                        color: Color(0xFF37352F),
                                        fontSize: 18,
                                        fontWeight: FontWeight.w400,
