            ...
            child: Obx(() => Column(
                  ...
                  children: [
                    AnimatedOpacity(
                      ...
                      curve: Curves.ease,
                      opacity: controller.offset.value > 4750 ? 1.0 : 0.0,
                      child: AnimatedPadding(
                        duration: const Duration(milliseconds: 1000),
                        curve: Curves.ease,
                        padding: EdgeInsets.only(top: controller.offset.value > 4750 ? 60 : 20),
                        child: RichText(
                          ...
                          text: const TextSpan(
                            ...
                            children: [
                              TextSpan(text: '맞추다는 준비되었어요.\n'),
                              TextSpan(
                                text: '당신도 시험에 합격할 준비가 되었나요?',
                                style: TextStyle(
                    ...
                    AnimatedOpacity(
                      duration: const Duration(milliseconds: 1000),
                      curve: Curves.ease,
                      opacity: controller.offset.value > 4900 ? 1.0 : 0.0,
                      child: AnimatedPadding(
                        duration: const Duration(milliseconds: 1000),
                        curve: Curves.ease,
                        padding: EdgeInsets.only(bottom: controller.offset.value > 4900 ? 60 : 20),
                        child: SizedBox(
                          width: 285,
                          height: 80,
